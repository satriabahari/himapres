                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title_event" wire:model="title_event"
                                            value="{{ old('title_event') }}" placeholder="Title">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" id="time_start"  wire:model="time_start"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" id="time_end"  wire:model="time_end"
                                        value="{{ old('time_end') }}">
                                    </div>
                                </div>
                            </div>
