                                ...
                                <div class="col-md-12 text-center">
                                    <form wire:submit.prevent="scanIdCard">
                                        <input type="password" class="form-control mx-auto" id="cardId"
                                            wire:model="cardId" placeholder="SCAN RFID atau INPUT ID" autofocus>
                                        <!-- Tombol submit form -->
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    @elseif ($currentHour >= 12 && $currentHour < 15)
                        <h3 class="text-center">Selamat Siang</h3>
                    @elseif ($currentHour >= 15 && $currentHour < 18)
                        <h3 class="text-center">Selamat Sore</h3>
                    @elseif ($currentHour >= 18 && $currentHour < 24)
                        <h3 class="text-center">Selamat Malam</h3>
                    @endif
