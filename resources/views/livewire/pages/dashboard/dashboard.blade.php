                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <span class="text-muted fs-12"><span class="text-pink"><i class="fe fe-arrow-down-circle text-pink"></i>
                                    {{ $countMahasiswa?number_format($countMahasiswa/$countAnggota*100, 2):0;}}%</span>
                                Form data Angota</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <span class="text-muted fs-12"><span class="text-green"><i class="fe fe-arrow-up-circle text-green"></i>
                                    {{ $countDosen?number_format($countDosen/$countAnggota*100, 2):0;}}%</span>
                                Form data Angota</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <span class="text-muted fs-12"><span class="text-warning"><i class="fe fe-arrow-up-circle text-warning"></i>
                                    {{ $countTamu?number_format($countTamu/$countAnggota*100, 2):0;}}%</span>
                                Form data Angota</span>
                        </div>
                    </div>
                </div>
