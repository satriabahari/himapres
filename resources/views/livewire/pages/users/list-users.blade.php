                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center border-0">
                                        <a href="{{ route('admin.users.show', $user->id) }}" class="btn btn-sm btn-primary badge  mx-2" wire:navigate><i class="fe fe-edit"></i></a>
                                        <form wire:submit='destroy({{$user->id}})' class="inline-block" wire:confirm="Yakin Ingin Menghapus?">
