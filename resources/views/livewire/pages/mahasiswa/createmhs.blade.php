                        ...
                        <div class="">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" wire:model="jabatan">
                                            <option value="Mahasiswa" @if (old('jabatan') == 'Mahasiswa') selected @endif>
                                                Mahasiswa</option>
                                            <option value="Dosen" @if (old('jabatan') == 'Dosen') selected @endif>
                                                Dosen</option>
                                            <option value="Tamu" @if (old('jabatan') == 'Tamu') selected @endif>
                                                Tamu</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <script>
                                        // const scannft = document.getElementById('card_id');
        ...
        <div class="col-md-12 col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a wire:click="getTemplateExcel()" id=" table2-new-row-button"
                        class="btn btn-primary btn-sm">Template</a>
                </div>
                <div class="card-body">
